  ...
  if (!article) {
    return (
      <div className="py-12 text-center">
        ...
        <h1 className="text-h2 font-bold text-light-text-primary dark:text-dark-text-primary mb-4">
          Article Not Found
        </h1>
        ...
        <Link
          to="/writing"
          className="px-4 py-2 bg-accent text-white rounded-button text-small font-medium hover:bg-opacity-90 transition-default"
        >
          Browse all articles
        </Link>
      </div>
  ...
  return (
    ...
    >
      {article.sections.map((section, idx) => (
        ...
        >
          <h2 className="text-h3 font-bold text-light-text-primary dark:text-dark-text-primary mb-4 sm:mb-6">
            {section.title}
          </h2>
          {section.content}
        </section>
