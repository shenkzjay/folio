  ...
  return (
    <div className="py-8 sm:py-12 animate-fade-in">
      ...
      <div className="flex flex-col gap-2 sm:gap-3 mb-8 sm:mb-12">
        ...
        <div className="flex flex-wrap text-small gap-3 sm:gap-6 items-center text-light-text-secondary dark:text-dark-text-secondary">
        ...
        <div>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block mt-4 sm:mt-6 px-4 py-2 bg-accent text-white rounded-button text-small font-medium hover:bg-opacity-90 transition-default"
          >
            Download resume
          </a>
        </div>
      ...
      <div className="border-y border-light-border dark:border-dark-border py-6 sm:py-8 mb-8 sm:mb-12">
        <h2 className="text-h3 font-semibold text-light-text-primary dark:text-dark-text-primary mb-3">
          Summary
        </h2>
      ...
      <div className="mb-8 sm:mb-12">
        <h2 className="text-h3 font-semibold text-light-text-primary dark:text-dark-text-primary mb-4 sm:mb-6">
          Technical Skills
        </h2>
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            <h3 className="text-small font-semibold uppercase tracking-wider text-light-text-secondary dark:text-dark-text-secondary">
              Frontend
            </h3>
          ...
          {resume.experience.map((job, idx) => (
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1">
                <div>
                  <h3 className="text-h4 font-semibold text-light-text-primary dark:text-dark-text-primary">
                    {job.role}
                  </h3>
                  <p className="text-small text-accent">{job.company}</p>
                </div>
              ...
              <ul className="flex flex-col gap-2 ml-4 list-disc">
                {job.highlights.map((highlight, hIdx) => (
                  <li
                    key={hIdx}
                    className="text-body text-light-text-secondary dark:text-dark-text-secondary leading-relaxed"
                  >
                    {highlight}
                  </li>
                ))}
